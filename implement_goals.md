...
The living next-slice pointer is `develop_plan.md` §1.1. Phase 8 HEIC still preview (H8.01–H8.06) is already shipped. Delivery Phase 9 remaining-stretch (S9.00–S9.13, `docs/plans/2026-09-04-remaining-stretch.md`) is closed. Leftover cache knobs ([#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)) shipped. Leftover dual-platform installer GUI DoD install+run ([#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)) shipped. Leftover packaged-desktop ≥500 GUI ([#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)) shipped. Leftover packaged macOS quit+job matrix ([#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)) shipped. Leftover packaged Windows quit+job matrix ([#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)) shipped. Leftover unsigned install tutorial ([#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)) shipped. Leftover unsigned desktop GitHub Release ([#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)) shipped. Leftover unsigned desktop Release with sidecar cold-start fix ([#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)) shipped. Leftover Win11 new-project Import/Export no-response ([#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)) shipped. Leftover unsigned desktop Release with Import/Export fix ([#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)) shipped. Leftover Win11 NSIS locked `_internal` upgrade ([#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)) shipped. Leftover unsigned desktop Release with NSIS locked-file hooks ([#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200)) shipped. Leftover Win11 File menu still does not navigate after ACL ([#210](https://github.com/joe-cheung-cae/frame-pilot/issues/210)) is the named next leftover. If §1.1 names no next slice, stop. Do not invent Phase 10. The Phase 0–7 / v2.0–v2.6 list inside the long-running prompt is historical product sequencing. Delivery Phase 7 is processing job cancel and already shipped; do not treat Goal Mode “Phase 7: v2.6” as current work.
...
6. Phase 9 remaining stretch is closed (S9.00–S9.13). Leftover cache knobs (#175) shipped. Leftover dual-platform installer GUI DoD install+run (#177) shipped. Leftover packaged-desktop ≥500 GUI (#179) shipped. Leftover packaged macOS quit+job matrix (#181) shipped. Leftover packaged Windows quit+job matrix (#184) shipped. Leftover unsigned install tutorial (#186) shipped. Leftover unsigned desktop GitHub Release (#188) shipped. Leftover unsigned desktop Release with Import/Export fix (#196) shipped. Leftover Win11 NSIS locked `_internal` upgrade (#198) shipped. Leftover unsigned desktop Release with NSIS locked-file hooks (#200) shipped. Leftover Win11 File menu still does not navigate after ACL (#210) is the named next leftover. Phase 8 HEIC still preview is shipped; do not re-implement it. Do not invent Phase 10. If §1.1 names no next slice, stop rather than picking from historical lists.
...
- If `develop_plan.md` §1.1 names no next slice, stop.

Acceptance criteria:
- The Phase 8 Definition of Done in that plan is already ticked.
- Phase 9 remaining-stretch is closed (S9.00–S9.13). Leftover cache knobs (#175) shipped. Leftover dual-platform installer GUI DoD install+run (#177) shipped. Leftover packaged-desktop ≥500 GUI (#179) shipped. Leftover packaged macOS quit+job matrix (#181) shipped. Leftover packaged Windows quit+job matrix (#184) shipped. Leftover unsigned install tutorial (#186) shipped. Leftover unsigned desktop GitHub Release (#188) shipped. Leftover unsigned desktop Release with Import/Export fix (#196) shipped. Leftover Win11 NSIS locked `_internal` upgrade (#198) shipped. Leftover unsigned desktop Release with NSIS locked-file hooks (#200) shipped. Leftover Win11 File menu still does not navigate after ACL (#210) is the named next leftover. If §1.1 names no next slice, do not start a new implementation loop.
