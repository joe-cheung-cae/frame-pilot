...
Face and eye-open fields are local heuristic scores derived from simple color, shape, luminance, and sharpness checks. They are not generated by a bundled professional face detection model and should be treated as weak MVP ranking hints.
