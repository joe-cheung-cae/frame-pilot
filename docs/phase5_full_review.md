...
| ----- | ------ | ---------- |
| [#96](https://github.com/joe-cheung-cae/frame-pilot/issues/96) | Resolved | Docs clarify multipart vs `from-paths` |
| [#97](https://github.com/joe-cheung-cae/frame-pilot/issues/97) | Resolved | `perf:api --import-mode from-paths` + 100-photo RSS row |
| [#98](https://github.com/joe-cheung-cae/frame-pilot/issues/98) | Resolved (docs) | Public provenance + signing checklist; certs remain org secrets |
