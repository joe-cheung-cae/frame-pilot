...
- 未签名 Windows NSIS GUI 生命周期 QA（[#144](https://github.com/joe-cheung-cae/frame-pilot/issues/144)，2026-09-04 按 Windows-only 关闭）。残留双平台安装包 GUI DoD **安装并运行**（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)，`2026-09-07T09:34:57Z`，[desktop.yml run 34105891421](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34105891421)）：包装 macOS DMG attach + 启动 + 回环 `GET /health`（`APP_VERSION=2.1.0-desktop`）。S9.12（[#172](https://github.com/joe-cheung-cae/frame-pilot/issues/172)）于 `2026-09-05T12:31:10Z` 保持 **skip，不是 pass** 作为历史。完整退出+作业矩阵仍未排期。
...
**下一步：** 残留衍生缓存大小与淘汰已交付（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。残留双平台安装包 GUI DoD 安装并运行已交付（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)）。残留包装桌面 ≥500 GUI 已交付（[#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)）。仍未排期：自动下载安装、处理池、完整 RAW 显影、SmartScreen/商店上架、完整包装 macOS 退出+作业矩阵。不要发明第十阶段。
