...
**下一步：** 残留包装 Windows 退出+作业矩阵（[#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)）。残留衍生缓存大小与淘汰已交付（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。残留双平台安装包 GUI DoD 安装并运行已交付（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)）。残留包装桌面 ≥500 GUI 已交付（[#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)）。残留包装 macOS 退出+作业矩阵已交付（[#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)）。仍未排期：自动下载安装、处理池、完整 RAW 显影、SmartScreen/商店上架。不要发明第十阶段。
