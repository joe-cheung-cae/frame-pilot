...
- 未签名 Windows NSIS GUI 生命周期 QA（[#144](https://github.com/joe-cheung-cae/frame-pilot/issues/144)，2026-09-04 按 Windows-only 关闭）。残留双平台安装包 GUI DoD **安装并运行**（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)，`2026-09-07T09:34:57Z`，[desktop.yml run 34105891421](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34105891421)）：包装 macOS DMG attach + 启动 + 回环 `GET /health`（`APP_VERSION=2.1.0-desktop`）。S9.12（[#172](https://github.com/joe-cheung-cae/frame-pilot/issues/172)）于 `2026-09-05T12:31:10Z` 保持 **skip，不是 pass** 作为历史。残留包装 macOS 退出+作业矩阵已交付（[#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)，`2026-09-08T13:26:18Z`，[desktop.yml run 34230112750](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34230112750)）。
...
- 残留桌面 §5.4 cache 旋钮：设置显示缩略图和预览缓存大小；**Clear thumbnails and previews** 只删除 `{project}/thumbnails/` 与 `{project}/previews/`（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。
- 残留无人值守包装桌面 ≥500 GUI（[#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)，Windows `2026-09-07T19:39:23Z` + macOS `2026-09-07T19:30:33Z`，[desktop.yml run 34155284835](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34155284835)）：包装 WebView from-paths + 审片预览（**原生对话框 stub**）；`accepted_files=500`；`APP_VERSION=2.1.0-desktop`。计划：[docs/plans/2026-09-07-desktop-500-gui.zh.md](docs/plans/2026-09-07-desktop-500-gui.zh.md)。
- 残留包装 macOS 退出+作业矩阵（[#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)，`2026-09-08T13:26:18Z`，[desktop.yml run 34230112750](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34230112750)）：Quit clean、Quit+导入、Quit+分组排序、Quit+导出在 Darwin `macos-latest` 上均为 `result=pass`（500 张 JPEG 3000×2000 q88；Path B 启动 + 生产退出；**Quit and cancel**）。计划：[docs/plans/2026-09-08-desktop-quit-job-matrix.zh.md](docs/plans/2026-09-08-desktop-quit-job-matrix.zh.md)。
- 残留包装 Windows 退出+作业矩阵（[#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)，`2026-09-08T15:29:33Z`，[desktop.yml run 34242430942](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34242430942)）：Quit clean、Quit+导入、Quit+分组排序、Quit+导出在 Windows `windows-latest` 上均为 `result=pass`（500 张 JPEG 3000×2000 q88；Path B 启动 + 生产 `CloseMainWindow`；**Quit and cancel**）。计划：[docs/plans/2026-09-08-desktop-quit-job-windows.zh.md](docs/plans/2026-09-08-desktop-quit-job-windows.zh.md)。
- 残留未签名安装教程（[#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)）：中英 [docs/desktop_install.md](docs/desktop_install.zh.md)，覆盖未签名 macOS DMG 与 Windows NSIS（Actions 下载、Gatekeeper / SmartScreen、启动与退出）。不是已签名商店发行。
- 残留未签名桌面 GitHub Release（[#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)）：`desktop-release.yml` 发布未签名 Windows NSIS + macOS DMG（`v2.1.0-desktop`）；说明标明未签名并链到 `docs/desktop_install`。未签名、未公证、未上架。计划：[docs/plans/2026-09-09-unsigned-desktop-release.zh.md](docs/plans/2026-09-09-unsigned-desktop-release.zh.md)。
- 残留 Windows 包装 sidecar 首启 ready-line timeout（[#190](https://github.com/joe-cheung-cae/frame-pilot/issues/190)）：Windows 启动预算 120 秒、`{data_dir}/logs/sidecar.ready` 回退、spawn 工作目录 / `CREATE_NO_WINDOW` / 无缓冲 stdio。不要当成已签名。不要重开托盘 / D3.06。
- 残留含 sidecar 冷首启修的未签名桌面 GitHub Release（[#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)）：`desktop-release.yml` 从含 [#191](https://github.com/joe-cheung-cae/frame-pilot/pull/191)（`602c022`+）的 `desktop.yml` 运行发布未签名 Windows NSIS + macOS DMG（`v2.1.1-desktop`）。说明标明未签名、写明 120 秒 ready-line 修，并链到 `docs/desktop_install`。不改 `APP_VERSION`。未签名、未公证、未上架。计划：[docs/plans/2026-09-09-unsigned-desktop-sidecar-release.zh.md](docs/plans/2026-09-09-unsigned-desktop-sidecar-release.zh.md)。
- 残留 Win11 新建工程「导入/导出」无响应（[#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)）：File → Import/Export 在没有项目 id 时不再静默忽略；新建工程会记住该项目；工作流选项卡始终打开导入和导出页。不改 `APP_VERSION`。不要重开托盘 / D3.06。
- 残留含导入/导出修的未签名桌面 GitHub Release（[#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)）：`desktop-release.yml` 从含 [#195](https://github.com/joe-cheung-cae/frame-pilot/pull/195)（`6b147160`+）的 `desktop.yml` 运行发布未签名 Windows NSIS + macOS DMG（`v2.1.2-desktop`）。说明标明未签名、写明导入/导出修以及此前 #191 sidecar 120 秒修，并链到 `docs/desktop_install`。不改 `APP_VERSION`。未签名、未公证、未上架。计划：[docs/plans/2026-09-09-unsigned-desktop-import-export-release.zh.md](docs/plans/2026-09-09-unsigned-desktop-import-export-release.zh.md)。
- 残留 Win11 NSIS 升级时 `_internal` 被锁（[#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)）：NSIS `installerHooks` PREINSTALL/PREUNINSTALL 在 FramePilot / `framepilot-api` 仍锁着 sidecar `_internal` DLL 时停住（只有 Retry/Cancel；不能一路 Ignore 装出残缺包）。Win11「应用仍在运行时升级」书面步骤见 [docs/desktop_install.md](docs/desktop_install.zh.md)。不改 `APP_VERSION`。不要重开托盘 / D3.06。计划：[docs/plans/2026-09-09-nsis-locked-internal-upgrade.md](docs/plans/2026-09-09-nsis-locked-internal-upgrade.zh.md)。
- 残留含 NSIS 锁文件 hooks 的未签名桌面 GitHub Release（[#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200)，`2026-09-09T09:01:01Z`，[v2.1.3-desktop](https://github.com/joe-cheung-cae/frame-pilot/releases/tag/v2.1.3-desktop)）：`desktop-release.yml` 从含 [#199](https://github.com/joe-cheung-cae/frame-pilot/pull/199)（`d9d29e8e`+）的 `desktop.yml` 运行发布未签名 Windows NSIS（`FramePilot_2.1.0-desktop_x64-setup.exe`）+ macOS DMG（`FramePilot_2.1.0-desktop_aarch64.dmg`）（`v2.1.3-desktop`）；资源 `2026-09-09T09:29:22Z`。说明标明未签名、写明 #198 锁文件停住（Retry/Cancel，无 Ignore-through）以及此前 #194/#195 导入/导出与 #191 sidecar 120 秒修，并链到 `docs/desktop_install`。不改 `APP_VERSION`。未签名、未公证、未上架。计划：[docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.md](docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.zh.md)。

已在 `feature/leftover-raw-develop` 交付（未合并进 `main`）：残留无内嵌预览时的 RAW 回退显影（[#202](https://github.com/joe-cheung-cae/frame-pilot/issues/202)）。`open_raw_import_image` 先 `extract_thumb`，仅当 thumb 失败才走锁定 LibRaw `postprocess`（`use_camera_wb=True`、`no_auto_bright=True`、`output_bps=8`、`half_size=True`）。`extract_raw_preview_image` 仍只抽 thumb。两条路径都失败时跳过：`RAW file could not be developed; no embedded preview and demosaic failed`；清理 `originals/` 拷贝。不是 RAW 编辑器。无额外扩展名。不改 `APP_VERSION`。计划：[docs/plans/2026-09-11-leftover-raw-develop.md](docs/plans/2026-09-11-leftover-raw-develop.zh.md)。

**下一步：** 没有进一步点名的残留。仍未排期：自动下载安装、处理池、色彩管理 RAW / 额外扩展名、SmartScreen/商店上架。残留衍生缓存大小与淘汰已交付（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。残留双平台安装包 GUI DoD 安装并运行已交付（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)）。残留包装桌面 ≥500 GUI 已交付（[#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)）。残留包装 macOS 退出+作业矩阵已交付（[#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)）。残留包装 Windows 退出+作业矩阵已交付（[#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)）。残留未签名安装教程已交付（[#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)）。残留未签名桌面 GitHub Release 已交付（[#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)）。残留 Windows 包装 sidecar ready-line timeout 已交付（[#190](https://github.com/joe-cheung-cae/frame-pilot/issues/190)）。残留含 sidecar 冷首启修的未签名桌面 Release 已交付（[#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)）。残留 Win11 新建工程「导入/导出」无响应已交付（[#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)）。残留含导入/导出修的未签名桌面 Release 已交付（[#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)）。残留 Win11 NSIS 升级时 `_internal` 被锁已交付（[#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)）。残留含 NSIS 锁文件 hooks 的未签名桌面 Release 已交付（[#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200)，[v2.1.3-desktop](https://github.com/joe-cheung-cae/frame-pilot/releases/tag/v2.1.3-desktop)，`2026-09-09T09:01:01Z`）。残留 RAW 回退显影已在本分支交付（[#202](https://github.com/joe-cheung-cae/frame-pilot/issues/202)）。不要发明第十阶段。
