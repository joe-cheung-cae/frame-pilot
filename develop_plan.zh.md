...
- 残留含 NSIS 锁文件 hooks 的未签名桌面 GitHub Release（[#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200)）：`desktop-release.yml` 从含 [#199](https://github.com/joe-cheung-cae/frame-pilot/pull/199)（`d9d29e8e`+）的 `desktop.yml` 运行发布未签名 Windows NSIS + macOS DMG（`v2.1.3-desktop`）。说明标明未签名、写明 #198 锁文件停住（Retry/Cancel，无 Ignore-through）以及此前 #194/#195 导入/导出与 #191 sidecar 120 秒修，并链到 `docs/desktop_install`。不改 `APP_VERSION`。未签名、未公证、未上架。计划：[docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.md](docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.zh.md)。

**下一步：** 当前残留是含 NSIS 锁文件 hooks 的未签名桌面 GitHub Release（[#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200)）（实现者不合入）。仍未排期：自动下载安装、处理池、完整 RAW 显影、SmartScreen/商店上架。残留衍生缓存大小与淘汰已交付（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。残留双平台安装包 GUI DoD 安装并运行已交付（[#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)）。残留包装桌面 ≥500 GUI 已交付（[#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)）。残留包装 macOS 退出+作业矩阵已交付（[#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)）。残留包装 Windows 退出+作业矩阵已交付（[#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)）。残留未签名安装教程已交付（[#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)）。残留未签名桌面 GitHub Release 已交付（[#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)）。残留 Windows 包装 sidecar ready-line timeout 已交付（[#190](https://github.com/joe-cheung-cae/frame-pilot/issues/190)）。残留含 sidecar 冷首启修的未签名桌面 Release 已交付（[#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)）。残留 Win11 新建工程「导入/导出」无响应已交付（[#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)）。残留含导入/导出修的未签名桌面 Release 已交付（[#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)）。残留 Win11 NSIS 升级时 `_internal` 被锁已交付（[#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)）。不要发明第十阶段。
