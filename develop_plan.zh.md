...
**下一步：** 残留衍生缓存大小与淘汰已交付（[#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)）。仍未排期：自动下载安装、处理池、完整 RAW 显影、SmartScreen/商店上架、包装桌面 ≥500 GUI、macOS GUI pass。不要发明第十阶段。
