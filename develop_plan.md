...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.02 are landed (export cancel [#164](https://github.com/joe-cheung-cae/frame-pilot/issues/164), J7.07 pause [#161](https://github.com/joe-cheung-cae/frame-pilot/issues/161)); start at **S9.03 AVIF still preview** ([#163](https://github.com/joe-cheung-cae/frame-pilot/issues/163)). Do not invent Phase 10. Do not implement S9.04–S9.13 in the same run as S9.03.
