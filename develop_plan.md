...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.11 are landed (through signing-ready CI [#171](https://github.com/joe-cheung-cae/frame-pilot/issues/171)); start at **S9.12 macOS DMG GUI QA** ([#172](https://github.com/joe-cheung-cae/frame-pilot/issues/172)). Do not invent Phase 10. Do not implement S9.13 in the same run as S9.12.
