...
**Next:** Leftover packaged Windows quit+job matrix ([#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)). Leftover derivative cache size and eviction shipped ([#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)). Leftover dual-platform installer GUI DoD install+run shipped ([#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)). Leftover packaged-desktop ≥500 GUI shipped ([#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)). Leftover packaged macOS quit+job matrix shipped ([#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)). Remaining unscheduled: auto-download/install, processing pool, full RAW develop, SmartScreen/store listing. Do not invent Phase 10.
