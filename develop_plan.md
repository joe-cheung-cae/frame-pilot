...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.05 are landed (through XMP [#165](https://github.com/joe-cheung-cae/frame-pilot/issues/165)); start at **S9.06 optional system tray** ([#169](https://github.com/joe-cheung-cae/frame-pilot/issues/169)). Do not invent Phase 10. Do not implement S9.07–S9.13 in the same run as S9.06.
