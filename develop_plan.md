...
- Unsigned Windows NSIS GUI lifecycle QA ([#144](https://github.com/joe-cheung-cae/frame-pilot/issues/144), closed Windows-only 2026-09-04). S9.12 packaged macOS DMG GUI lifecycle ([#172](https://github.com/joe-cheung-cae/frame-pilot/issues/172)) recorded **skip, not pass** at `2026-09-05T12:31:10Z` (Linux/WSL2; `uname -s` is not Darwin). Skip is not a macOS pass.
...
**Next:** Leftover derivative cache size and eviction shipped ([#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)). Remaining unscheduled: auto-download/install, processing pool, full RAW develop, SmartScreen/store listing, packaged-desktop ≥500 GUI, macOS GUI pass. Do not invent Phase 10.
