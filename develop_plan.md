...
- Unsigned Windows NSIS GUI lifecycle QA ([#144](https://github.com/joe-cheung-cae/frame-pilot/issues/144), closed Windows-only 2026-09-04). Leftover dual-platform installer GUI DoD **install+run** ([#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177), `2026-09-07T09:34:57Z`, [desktop.yml run 34105891421](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34105891421)): packaged macOS DMG attach + launch + loopback `GET /health` (`APP_VERSION=2.1.0-desktop`). S9.12 ([#172](https://github.com/joe-cheung-cae/frame-pilot/issues/172)) stays **skip, not pass** at `2026-09-05T12:31:10Z` as history. Leftover packaged macOS quit+job matrix shipped ([#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181), `2026-09-08T13:26:18Z`, [desktop.yml run 34230112750](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34230112750)).
- Phase 8 local **HEIC/HEIF still preview** (H8.01–H8.06, [#157](https://github.com/joe-cheung-cae/frame-pilot/pull/157); [#151](https://github.com/joe-cheung-cae/frame-pilot/issues/151) closed). Plan: [docs/plans/2026-09-04-heic-preview.md](docs/plans/2026-09-04-heic-preview.md). Copy original HEIC unchanged; decode with `pillow-heif`; WebP derivatives; score/group on RGB. RAW stays skipped in that phase.
- Phase 9 remaining-stretch close-out (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). Export cancel, processing pause, AVIF, RAW embedded preview, XMP export, tray, detached preview, import workers, data-dir, check-for-updates, signing-ready CI, macOS DMG GUI skip (not pass), docs leftover repair.
- Leftover desktop §5.4 cache knobs: Settings shows thumbnail and preview cache size; **Clear thumbnails and previews** deletes only `{project}/thumbnails/` and `{project}/previews/` ([#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)).
- Leftover unattended packaged-desktop ≥500 GUI ([#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179), Windows `2026-09-07T19:39:23Z` + macOS `2026-09-07T19:30:33Z`, [desktop.yml run 34155284835](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34155284835)): packaged WebView from-paths + culling preview (**native dialog stubbed**); `accepted_files=500`; `APP_VERSION=2.1.0-desktop`. Plan: [docs/plans/2026-09-07-desktop-500-gui.md](docs/plans/2026-09-07-desktop-500-gui.md).
- Leftover packaged macOS quit+job matrix ([#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181), `2026-09-08T13:26:18Z`, [desktop.yml run 34230112750](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34230112750)): Quit clean, Quit+import, Quit+processing, Quit+export all `result=pass` on Darwin `macos-latest` (500 JPEG 3000×2000 q88; Path B start + production quit; **Quit and cancel**). Plan: [docs/plans/2026-09-08-desktop-quit-job-matrix.md](docs/plans/2026-09-08-desktop-quit-job-matrix.md).
- Leftover packaged Windows quit+job matrix ([#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184), `2026-09-08T15:29:33Z`, [desktop.yml run 34242430942](https://github.com/joe-cheung-cae/frame-pilot/actions/runs/34242430942)): Quit clean, Quit+import, Quit+processing, Quit+export all `result=pass` on Windows `windows-latest` (500 JPEG 3000×2000 q88; Path B start + production `CloseMainWindow`; **Quit and cancel**). Plan: [docs/plans/2026-09-08-desktop-quit-job-windows.md](docs/plans/2026-09-08-desktop-quit-job-windows.md).
- Leftover unsigned install tutorial ([#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)): bilingual [docs/desktop_install.md](docs/desktop_install.md) for unsigned macOS DMG and Windows NSIS (Actions download, Gatekeeper / SmartScreen, start/stop). Not a signed store release.
- Leftover unsigned desktop GitHub Release ([#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)): `desktop-release.yml` publishes unsigned Windows NSIS + macOS DMG (`v2.1.0-desktop`); notes mark unsigned and link `docs/desktop_install`. Not signed, notarized, or store-listed. Plan: [docs/plans/2026-09-09-unsigned-desktop-release.md](docs/plans/2026-09-09-unsigned-desktop-release.md).
- Leftover Windows packaged sidecar first-launch ready-line timeout ([#190](https://github.com/joe-cheung-cae/frame-pilot/issues/190)): 120s Windows startup budget, `{data_dir}/logs/sidecar.ready` fallback, spawn cwd / `CREATE_NO_WINDOW` / unbuffered stdio. Do not treat as signed. Do not reopen tray / D3.06.
- Leftover unsigned desktop GitHub Release with sidecar cold-start fix ([#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)): `desktop-release.yml` publishes unsigned Windows NSIS + macOS DMG as `v2.1.1-desktop` from a `desktop.yml` run that includes [#191](https://github.com/joe-cheung-cae/frame-pilot/pull/191) (`602c022`+). Notes mark unsigned, name the 120s ready-line fix, and link `docs/desktop_install`. No `APP_VERSION` bump. Not signed, notarized, or store-listed. Plan: [docs/plans/2026-09-09-unsigned-desktop-sidecar-release.md](docs/plans/2026-09-09-unsigned-desktop-sidecar-release.md).
- Leftover Win11 new-project Import/Export no-response ([#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)): File → Import/Export no longer silently ignores a missing project id; Create Project remembers the new project; workflow tabs always open Import and Export. No `APP_VERSION` bump. Do not reopen tray / D3.06.
- Leftover unsigned desktop GitHub Release with Import/Export fix ([#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)): `desktop-release.yml` publishes unsigned Windows NSIS + macOS DMG as `v2.1.2-desktop` from a `desktop.yml` run that includes [#195](https://github.com/joe-cheung-cae/frame-pilot/pull/195) (`6b147160`+). Notes mark unsigned, name the Import/Export fix plus the earlier #191 sidecar 120s fix, and link `docs/desktop_install`. No `APP_VERSION` bump. Not signed, notarized, or store-listed. Plan: [docs/plans/2026-09-09-unsigned-desktop-import-export-release.md](docs/plans/2026-09-09-unsigned-desktop-import-export-release.md).
- Leftover Win11 NSIS locked `_internal` upgrade ([#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)): NSIS `installerHooks` PREINSTALL/PREUNINSTALL stop when FramePilot / `framepilot-api` still lock sidecar `_internal` DLLs (Retry/Cancel only; no Ignore-through half install). Written Win11 upgrade-while-running steps in [docs/desktop_install.md](docs/desktop_install.md). No `APP_VERSION` bump. Do not reopen tray / D3.06. Plan: [docs/plans/2026-09-09-nsis-locked-internal-upgrade.md](docs/plans/2026-09-09-nsis-locked-internal-upgrade.md).
- Leftover unsigned desktop GitHub Release with NSIS locked-file hooks ([#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200), `2026-09-09T09:01:01Z`, [v2.1.3-desktop](https://github.com/joe-cheung-cae/frame-pilot/releases/tag/v2.1.3-desktop)): `desktop-release.yml` publishes unsigned Windows NSIS (`FramePilot_2.1.0-desktop_x64-setup.exe`) + macOS DMG (`FramePilot_2.1.0-desktop_aarch64.dmg`) as `v2.1.3-desktop` from a `desktop.yml` run that includes [#199](https://github.com/joe-cheung-cae/frame-pilot/pull/199) (`d9d29e8e`+); assets `2026-09-09T09:29:22Z`. Notes mark unsigned, name the #198 locked-file stop (Retry/Cancel, no Ignore-through) plus the earlier #194/#195 Import/Export and #191 sidecar 120s fixes, and link `docs/desktop_install`. No `APP_VERSION` bump. Not signed, notarized, or store-listed. Plan: [docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.md](docs/plans/2026-09-09-unsigned-desktop-nsis-hooks-release.md).

Shipped on `feature/leftover-raw-develop` (not merged to `main`): leftover RAW fallback develop (no embedded preview) ([#202](https://github.com/joe-cheung-cae/frame-pilot/issues/202)). `open_raw_import_image` tries `extract_thumb` first, then locked LibRaw `postprocess` (`use_camera_wb=True`, `no_auto_bright=True`, `output_bps=8`, `half_size=True`) only when thumb fails. `extract_raw_preview_image` stays thumb-only. Skip when both fail: `RAW file could not be developed; no embedded preview and demosaic failed`; cleanup `originals/` copy. Not a RAW editor. No extra extensions. No `APP_VERSION` bump. Plan: [docs/plans/2026-09-11-leftover-raw-develop.md](docs/plans/2026-09-11-leftover-raw-develop.md).

**Next:** No further named leftover. Remaining unscheduled: auto-download/install, processing pool, color-managed RAW / extra extensions, SmartScreen/store listing. Leftover derivative cache size and eviction shipped ([#175](https://github.com/joe-cheung-cae/frame-pilot/issues/175)). Leftover dual-platform installer GUI DoD install+run shipped ([#177](https://github.com/joe-cheung-cae/frame-pilot/issues/177)). Leftover packaged-desktop ≥500 GUI shipped ([#179](https://github.com/joe-cheung-cae/frame-pilot/issues/179)). Leftover packaged macOS quit+job matrix shipped ([#181](https://github.com/joe-cheung-cae/frame-pilot/issues/181)). Leftover packaged Windows quit+job matrix shipped ([#184](https://github.com/joe-cheung-cae/frame-pilot/issues/184)). Leftover unsigned install tutorial shipped ([#186](https://github.com/joe-cheung-cae/frame-pilot/issues/186)). Leftover unsigned desktop GitHub Release shipped ([#188](https://github.com/joe-cheung-cae/frame-pilot/issues/188)). Leftover Windows packaged sidecar ready-line timeout shipped ([#190](https://github.com/joe-cheung-cae/frame-pilot/issues/190)). Leftover unsigned desktop Release with sidecar cold-start fix shipped ([#192](https://github.com/joe-cheung-cae/frame-pilot/issues/192)). Leftover Win11 new-project Import/Export no-response shipped ([#194](https://github.com/joe-cheung-cae/frame-pilot/issues/194)). Leftover unsigned desktop Release with Import/Export fix shipped ([#196](https://github.com/joe-cheung-cae/frame-pilot/issues/196)). Leftover Win11 NSIS locked `_internal` upgrade shipped ([#198](https://github.com/joe-cheung-cae/frame-pilot/issues/198)). Leftover unsigned desktop Release with NSIS locked-file hooks shipped ([#200](https://github.com/joe-cheung-cae/frame-pilot/issues/200), [v2.1.3-desktop](https://github.com/joe-cheung-cae/frame-pilot/releases/tag/v2.1.3-desktop), `2026-09-09T09:01:01Z`). Leftover RAW fallback develop shipped on this branch ([#202](https://github.com/joe-cheung-cae/frame-pilot/issues/202)). Do not invent Phase 10.

Closed queue: S9.01 export cancel → S9.02 J7.07 pause → S9.03 AVIF → S9.04 RAW preview → S9.05 XMP ([#165](https://github.com/joe-cheung-cae/frame-pilot/issues/165); historical [#117](https://github.com/joe-cheung-cae/frame-pilot/issues/117)) → S9.06 tray → S9.07 detached preview → S9.08 concurrency knobs → S9.09 data-dir → S9.10 optional updates → S9.11 signing-ready CI → S9.12 macOS DMG QA → S9.13 docs leftover repair.
