...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.10 are landed (through check for updates [#167](https://github.com/joe-cheung-cae/frame-pilot/issues/167)); start at **S9.11 signing-ready CI** ([#171](https://github.com/joe-cheung-cae/frame-pilot/issues/171)). Do not invent Phase 10. Do not implement S9.12–S9.13 in the same run as S9.11.
