...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.09 are landed (through data directory [#170](https://github.com/joe-cheung-cae/frame-pilot/issues/170)); start at **S9.10 optional check for updates** ([#167](https://github.com/joe-cheung-cae/frame-pilot/issues/167)). Do not invent Phase 10. Do not implement S9.11–S9.13 in the same run as S9.10.
