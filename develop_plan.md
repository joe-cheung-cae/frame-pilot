...
**Next:** Phase 9 remaining-stretch close-out, **one GitHub issue per run** (S9.00–S9.13). Plan: [docs/plans/2026-09-04-remaining-stretch.md](docs/plans/2026-09-04-remaining-stretch.md). Umbrella [#160](https://github.com/joe-cheung-cae/frame-pilot/issues/160). S9.00–S9.12 are landed (S9.12 macOS DMG GUI is skip, not pass); start at **S9.13 docs leftover repair** ([#173](https://github.com/joe-cheung-cae/frame-pilot/issues/173)). Do not invent Phase 10.
