...
const BROWSER_COPY: ShellCopy = {
  ...
  cullingEmptyImportDetail: "Import JPEG, PNG, WebP, HEIC/HEIF, AVIF, or RAW images before opening the culling workspace.",
...
const DESKTOP_COPY: ShellCopy = {
  chooseFolder: "Choose a folder",
  cullingEmptyImportDetail: "Choose a folder of JPEG, PNG, WebP, HEIC/HEIF, AVIF, or RAW images before opening the culling workspace.",
  exportCopyPathRecovery:
